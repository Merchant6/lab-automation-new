            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5 ">
              ...
              @csrf
                <div class="form-group">
                  <input type="text" name="username" class="form-control form-control-lg border-dark" id="exampleInputUsername1" placeholder="Username">
                </div>
                ...
                <div class="form-group">
                  <input type="password" name="confirm_password" class="form-control form-control-lg border-dark" id="exampleConfirmPassword1" placeholder="Confirm Password">
                </div>

                
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html">SIGN UP</buttoaction="{{ route('login.custom') }}"n>
                </div>
